...
if($do=='content_insert'){
	...
	$content_title_en=empty($_POST['content_title_en'])?'':trim(addslashes($_POST['content_title_en']));
	...
	$content_text_en=empty($_POST['content_text_en'])?'':trim(addslashes($_POST['content_text_en']));
	...
	$insert['content_title_en']=$content_title_en;
	...
	$insert['content_text_en']=$content_text_en;
...
if($do=='content_edit'){
	...
	$content['title_en']=$row['content_title_en'];
	...
	$content['text_en']=$row['content_text_en'];
...
if($do=='content_update'){
	...
	$update['content_title_en']=$content_title_en;
	...
	$update['content_text_en']=$content_text_en;
