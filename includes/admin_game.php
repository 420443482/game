...
if($do=='game_insert'){
	...
	$game['game_login_gateway']=empty($_POST['game_login_gateway'])?'':addslashes(trim($_POST['game_login_gateway']));
	$game['game_pay_gateway']=empty($_POST['game_pay_gateway'])?'':addslashes(trim($_POST['game_pay_gateway']));
	$game['game_port_config1']=empty($_POST['game_port_config1'])?'':addslashes(trim($_POST['game_port_config1']));
	$game['game_port_config2']=empty($_POST['game_port_config2'])?'':addslashes(trim($_POST['game_port_config2']));
	$game['game_port_config3']=empty($_POST['game_port_config3'])?'':addslashes(trim($_POST['game_port_config3']));
	$game['game_port_config4']=empty($_POST['game_port_config4'])?'':addslashes(trim($_POST['game_port_config4']));
	$game['game_port_config5']=empty($_POST['game_port_config5'])?'':addslashes(trim($_POST['game_port_config5']));
	$game['game_port_s1']=empty($_POST['game_port_s1'])?'':addslashes(trim($_POST['game_port_s1']));
	$game['game_port_s2']=empty($_POST['game_port_s2'])?'':addslashes(trim($_POST['game_port_s2']));
	$game['game_port_s3']=empty($_POST['game_port_s3'])?'':addslashes(trim($_POST['game_port_s3']));
	$game['game_port_s4']=empty($_POST['game_port_s4'])?'':addslashes(trim($_POST['game_port_s4']));
	$game['game_port_s5']=empty($_POST['game_port_s5'])?'':addslashes(trim($_POST['game_port_s5']));
...
if($do=='pay_rehash'){
	...
	$order_no=empty($_GET['order_no'])?'':intval($_GET['order_no']);
	if(empty($order_no)){
		exit;
	}
	//充值处理
