...
$.fn.cld=function(options){
	...
	function carHtml(vYear,vMonth,vDay,vipt){
		...
		carArr.push("<td width='25'>Year</td><td width='25' height='30'>");
		carArr.push("<input name='inMonth' type='text' id='inMonth' value='"+vMonth+"' maxlength='2' bj='cBj' /></td>");
		carArr.push("<td width='25'>Month</td><td width='20'><span id='yadd' bj='cBj'>&gt;&gt;</span></td><td width='13'>&nbsp;</td>");
		carArr.push("</tr></table></td></tr>");
		carArr.push("<tr id='cssWeek'><td>Sun</td><td>Mon</td>");
		carArr.push("<td>Tue</td><td>Wed</td>");
		carArr.push("<td>Thu</td><td>Fri</td>");
		carArr.push("<td>Sat</td></tr>");
