...
function get_channel_list(){
	...
	if($count>0){
			...
			foreach($res as $row){
				...
				$content_list[$row['content_id']]['title_en']=$row['content_title_en'];
				...
				$content_list[$row['content_id']]['text_en']=$row['content_text_en'];
			...
			$pagebar=pagebar("channel",$parameters,$page_current,$page_size,$count);
	}else{
			$pagebar="";
	}
